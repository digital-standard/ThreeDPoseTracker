...
public class VNectModel : MonoBehaviour
{
    ...
    public JointPoint[] Init(int inputImageSize, ConfigurationSetting config)
    {
        ...
        var lf = TriangleNormal(lHand.Transform.position, jointPoints[PositionIndex.lMid1.Int()].Transform.position, jointPoints[PositionIndex.lThumb2.Int()].Transform.position);
        lHand.InitRotation = lHand.Transform.rotation;
        lHand.Inverse = Quaternion.Inverse(Quaternion.LookRotation(jointPoints[PositionIndex.lHand.Int()].Transform.position - jointPoints[PositionIndex.lMid1.Int()].Transform.position, lf));
        lHand.InverseRotation = lHand.Inverse * lHand.InitRotation;

        var rHand = jointPoints[PositionIndex.rHand.Int()];
        var rf = TriangleNormal(rHand.Transform.position, jointPoints[PositionIndex.rMid1.Int()].Transform.position, jointPoints[PositionIndex.rThumb2.Int()].Transform.position);
        rHand.InitRotation = jointPoints[PositionIndex.rHand.Int()].Transform.rotation;
        rHand.Inverse = Quaternion.Inverse(Quaternion.LookRotation(jointPoints[PositionIndex.rHand.Int()].Transform.position - jointPoints[PositionIndex.rMid1.Int()].Transform.position, rf));
...
*/
    ...
    public void PoseUpdate()
    {
        ...
        */
        ...
        {
            var rf = TriangleNormal(rHand.Pos3D, jointPoints[PositionIndex.rMid1.Int()].Pos3D, jointPoints[PositionIndex.rThumb2.Int()].Pos3D);
            rHand.Transform.rotation = Quaternion.LookRotation(jointPoints[PositionIndex.rHand.Int()].Pos3D - jointPoints[PositionIndex.rMid1.Int()].Pos3D, rf) * rHand.InverseRotation;
        }
